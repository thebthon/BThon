...
async def ae(event):
    await edit_or_reply(
        event,
        "**[𝗕𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - قائمــة الاوامــر](t.me/BThon)\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n•  اوامر تجميع نقاط بوتات تمويل\n\n ◂ امر تجميع بوت المليار\n `.تجميع المليار `\n\n ◂ امر تجميع بوت العرب \n`.تجميع العرب`\n\n ◂ امر تجميع بوت الجوكر \n`.تجميع الجوكر` ** ",
        link_preview=False,
    )
