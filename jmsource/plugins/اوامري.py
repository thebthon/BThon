...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر بيثون
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == jmsource.uid:
            buttons = [
                [Button.inline("معلومات بيثون", data="AOMRDB")],
                [
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس بيثون هذه بعض المعلومات عن بيثون:

- سورس بيثون يمتلك اكثر من 100 أمر 
- بيثون هو افضل سورس عربي يتميز بالحماية

كل شيء يخص الفارات و الكلايش هنا : GR_vars
مجموعة المساعدة: @G_R_support""",
        buttons=[
            [Button.inline("رجوع", data="namevar")],
        ],
    )
