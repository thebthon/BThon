...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر 𝗚𝗥
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == jmsource.uid:
            buttons = [
                [Button.inline("معلومات 𝗚𝗥", data="AOMRDB")],
                [
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس 𝗚𝗥 هذه بعض المعلومات عن 𝗚𝗥:

- سورس 𝗚𝗥 يمتلك اكثر من 100 أمر 
- 𝗚𝗥 هو افضل سورس عربي يتميز بالحماية
